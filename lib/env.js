...
const schema = z.object({
  ...
  // Shared-sheet access. Optional: without it the app still works through
  // Google OAuth and file upload, and the shared-sheet option is hidden.
  GOOGLE_SERVICE_ACCOUNT_EMAIL: optional(z.string().email()),
  GOOGLE_SERVICE_ACCOUNT_KEY: optional(z.string().min(20)),
